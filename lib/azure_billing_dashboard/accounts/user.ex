defmodule AzureBillingDashboard.Accounts.User do
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, AzureBillingDashboard.Repo)
  ...
  """
  def valid_password?(%AzureBillingDashboard.Accounts.User{hashed_password: hashed_password}, password)
