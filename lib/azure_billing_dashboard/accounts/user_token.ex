defmodule AzureBillingDashboard.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias AzureBillingDashboard.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, AzureBillingDashboard.Accounts.User
